...
const (
	...
	Raft_ClientOperation_FullMethodName = "/raft.Raft/ClientOperation"
)
...
type RaftClient interface {
	...
	ClientOperation(ctx context.Context, in *ClientOperationRequest, opts ...grpc.CallOption) (*ClientOperationResponse, error)
}
...
func (c *raftClient) RequestVote(ctx context.Context, in *RequestVoteMessage, opts ...grpc.CallOption) (*RequestVoteResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *raftClient) ClientOperation(ctx context.Context, in *ClientOperationRequest, opts ...grpc.CallOption) (*ClientOperationResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ClientOperationResponse)
	err := c.cc.Invoke(ctx, Raft_ClientOperation_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RaftServer interface {
	...
	ClientOperation(context.Context, *ClientOperationRequest) (*ClientOperationResponse, error)
...
func (UnimplementedRaftServer) RequestVote(context.Context, *RequestVoteMessage) (*RequestVoteResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RequestVote not implemented")
}
func (UnimplementedRaftServer) ClientOperation(context.Context, *ClientOperationRequest) (*ClientOperationResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ClientOperation not implemented")
}
...
func _Raft_ClientOperation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ClientOperationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RaftServer).ClientOperation(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Raft_ClientOperation_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RaftServer).ClientOperation(ctx, req.(*ClientOperationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Raft_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ClientOperation",
			Handler:    _Raft_ClientOperation_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "server/raft_proto/raft.proto",
}
